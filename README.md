...
<!-- lw-downloads:start — this block is regenerated by the release pipeline.
     The platform headings carry their OS emoji (🐧 / 🪟, and 🍎 in the macOS
     block below); whatever regenerates these blocks must keep emitting them. -->
### 🐧 Linux — v0.12.7
